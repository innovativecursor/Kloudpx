...
const DetailsCard = ({ product }) => {
  ...
  return (
    <div className="px-1">
      <h1 className="font-light md:text-[13px] text-[11px] md:mt-1 text-color tracking-wide capitalize">
        {(product?.genericname?.slice(0, 20) || "No genericname") +
          (product?.genericname?.length > 20 ? "..." : "")}
      </h1>

      <h1 className="text-black font-semibold mt-1 sm:text-[12px] text-[9px] tracking-wide">
