...
const OrderDetails = () => {
  ...
  const seniorDiscount = parseFloat(orderDetails.senior_discount || 0).toFixed(2);
  const paidAmount = parseFloat(amountPay || 0).toFixed(2);
  ...
  return (
    <div className="md:p-6 mt-16 mx-[4vw]">
          ...
          {orderDetails.items?.map((item, idx) => (
            ...
            >
              <div className="flex flex-col gap-1">
                ...
                <p className="text-sm text-gray-500">Price: ₱{item?.price || 0}</p>
                <p className="text-sm text-gray-500">
      ...
      <div className="bg-white shadow-lg rounded-xl p-6 mb-8 flex flex-col md:flex-row md:items-end gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white shadow-inner rounded-xl p-6 border-l-4 border-blue-500">
          ...
          <div className="space-y-1 text-sm">
            ...
            <p>
              <span className="font-semibold">Age:</span> {customer?.Age || "N/A"}
            </p>
            <p>
              <span className="font-semibold">Gender:</span> {customer?.Gender || "N/A"}
            </p>
            <p>
        ...
        <div className="bg-white shadow-inner rounded-xl p-6 border-l-4 border-purple-500">
          ...
          <div className="space-y-1 text-sm">
            ...
            <p className="flex justify-between font-semibold">
              <span>Total Amount:</span> <span>₱{paidAmount}</span>
            </p>
          </div>
        </div>
      </div>
